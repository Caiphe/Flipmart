            ...
            <div class="sign-in-page">
                <div class="row" style="margin-bottom: 60px;">
                    ...
                    <div class="col-md-3 col-sm-6 create-new-account">
                        <img style="max-width: 100px;height: 100px; border-radius: 50%; display: flex;margin: 0px auto;" class="card-img-top" src="{{ (!empty(auth()->user()->profile_photo_path)) ? url('upload/user_images/'.auth()->user()->profile_photo_path) : url('upload/no-photo.jpeg') }}" alt="">
                        <ul class="list-group list-group-flush" style="margin-top: 20px;">
                            ...
                            <li class="mb-2" style="margin-bottom: 10px;"><a href="{{ route('dashboard') }}" class="btn btn-primary btn-sm btn-block">Dashboard</a></li>
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <form class="register-form outer-top-xs" method="POST" action="{{ route('user.profile.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="profile-photo-path"
