            ...
            <div class="sign-in-page">
                <div class="row" style="margin-bottom: 60px;">
                    ...
                    <div class="col-md-3 col-sm-6 create-new-account">
                        <img style="max-width: 100px;height: 100px; border-radius: 50%;" class="card-img-top" src="{{ (!empty($adminData->profile_photo_path)) ? url('upload/admin_images/'.$adminData->profile_photo_path) : url('upload/admin_images/no-photo.jpeg') }}" alt="">
                    ...
                    <div class="col-md-3 col-sm-6 create-new-account">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="mb-2" style="margin-bottom: 10px;"><a href="{{ route('user.profile') }}" class="btn btn-primary btn-sm btn-block">Profile Update</a></li>
